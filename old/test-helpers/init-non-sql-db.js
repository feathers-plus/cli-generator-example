...
module.exports = function initNonSqlDb (app) {
  ...
  return Promise.all([
    ...
    .then(() => Promise.all([
      user.create({ uuid: 0, firstName: 'John', lastName: 'Szwaronek', email: 'john@gmail.com', password: 'john' }),
      user.create({ uuid: 1, firstName: 'Jessica', lastName: 'Szwaronek', email: 'jessica@gmail.com', password: 'jessica' }),
      user.create({ uuid: 2, firstName: 'Nick', lastName: 'Roussis', email: 'nick@gmail.com', password: 'nick' }),
      user.create({ uuid: 3, firstName: 'Barbara', lastName: 'Lewis', email: 'barbara@gmail.com', password: 'barbara' })
    ]))
    .then(() => user.find())
    .then(result => {
