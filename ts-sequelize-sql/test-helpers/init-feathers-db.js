...
/*
  CREATE TABLE `foo` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `uuid` INTEGER, `foo` INTEGER, `createdAt` DATETIME NOT NULL, `updatedAt` DATETIME NOT NULL);
  CREATE TABLE Posts (id INTEGER PRIMARY KEY, uuid INTEGER, createdAt TIMESTAMP, updatedAt TIMESTAMP, authorUuid INTEGER, body TEXT, draft INTEGER );
  CREATE TABLE Comments (id INTEGER PRIMARY KEY, uuid INTEGER, createdAt TIMESTAMP, updatedAt TIMESTAMP, authorUuid INTEGER, postUuid INTEGER, body TEXT, archived INTEGER );
  CREATE TABLE Likes (id INTEGER PRIMARY KEY, uuid INTEGER, createdAt TIMESTAMP, updatedAt TIMESTAMP, authorUuid INTEGER, commentUuid INTEGER );
  CREATE TABLE Relationships (id INTEGER PRIMARY KEY, uuid INTEGER, createdAt TIMESTAMP, updatedAt TIMESTAMP, followerUuid INTEGER, followeeUuid INTEGER );
  CREATE TABLE IF NOT EXISTS "Users" (id INTEGER PRIMARY KEY, uuid INTEGER, createdAt TIMESTAMP, updatedAt TIMESTAMP, firstName TEXT, lastName TEXT, email TEXT, password TEXT );
*/
